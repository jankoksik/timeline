            ...
            <div class="card-body">
                <form action="{{ route('events.add') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="text" maxlength=64 class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <textarea rows="10" cols="30" class="form-control @error('description') is-invalid @enderror" id="description" name="description" > {{  old('description') }}</textarea>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="date"  class="form-control @error('esd') is-invalid @enderror" id="esd" name="esd" value="{{ old('esd') }}">
                            @if ($errors->has('esd'))
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                          <input type="date"  class="form-control @error('eed') is-invalid @enderror" id="eed" name="eed" value="{{ old('eed') }}">
                            @if ($errors->has('eed'))
